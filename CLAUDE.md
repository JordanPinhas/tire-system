...
9 סוכנים המתקשרים דרך Orchestrator מרכזי עם ניתוב חכם (מילות מפתח + AI fallback).
...
| סוכן Rely | agents/rely_agent.py | מילוי פוליאוריתן Rely®, T-25, חישוב כמות חומר, מלגזות |
